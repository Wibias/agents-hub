...
Copyright (c) 2026 David Ondrej. The complete retained license notice is in this
hub's `THIRD_PARTY_NOTICES.md` and `licenses/davidondrej-skills-MIT.txt`. Skill
Ratchet's executable preflight, evaluation contract, model parity, adversarial
schema, regression locking, and validators are original additions and are not
represented as part of this adapted checklist.
