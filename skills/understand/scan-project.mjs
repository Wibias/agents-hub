...
async function main() {
  ...
  for (const rel of candidates) {
    // Analysis output is persistent state, not project source. Git-backed
    // enumeration can still surface tracked state, so enforce this boundary
    // independently of ignore files and their negation rules.
    if (rel === '.understand-anything' || rel.startsWith('.understand-anything/')) {
      continue;
    }
