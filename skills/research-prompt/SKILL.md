...
description: >
  Writes a single-paragraph deep-research brief to hand to a human researcher or a
  deep-research AI. Use when the user wants a research brief, a "deep research prompt",
  a one-paragraph task for a researcher, or asks "what should our researcher look for".
  Produces ONE tight paragraph with full context, numbered sub-questions, and a
  per-finding output format. Does not run the research itself -- for that, see
